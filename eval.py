...
def evaluation():
    ...
    if args.ood == "odin":
        ...
        if args.ood == "isol":
            ...
            out_scores = scores[-len(out_scores):]
    ###################### Measure ######################
    utils.get_and_print_results(in_scores, out_scores, args.ood, args.method)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_classes', type=int, default=290, help='# of classes')
    # save and load
